  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .shared-asset-performance-pill{display:inline-flex;align-items:center;min-height:20px;padding:2px 7px;border-radius:999px;font-size:9px;line-height:1;font-weight:600;white-space:nowrap;box-sizing:border-box}
            ...
            <div className="shared-asset-hero-identity">
              ...
              <div style={{ marginLeft: 12, display: "flex", flexDirection: "column", justifyContent: "center", minWidth: 0 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 7, marginTop: 6, minWidth: 0 }}>
                  {assetType !== "INDEX" && (
                    <span className="nv-pilule nv-pilule-douce" style={{ color: "rgba(255,255,255,0.72)" }}>
                      {({ EQUITY: "Action", ETF: "ETF", CRYPTOCURRENCY: "Crypto" } as Record<string, string>)[assetType] ?? assetType}
                    </span>
                  )}
                  {quote?.global_rank != null && (
                    <span className="nv-pilule nv-pilule-douce" style={{ color: "rgba(255,255,255,0.72)" }}>#{quote.global_rank}</span>
                  )}
                  {exchange && !isCrypto && (
                    <span className="nv-pilule nv-pilule-douce" style={{ color: "rgba(255,255,255,0.58)", fontWeight: 500 }}>
