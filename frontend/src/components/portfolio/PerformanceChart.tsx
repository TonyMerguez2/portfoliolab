...
export default function PerformanceChart({
  ...
  /**
   * Le tracé en cours, et le contexte qui décide s'il doit rejouer.
   *
   * ⚠️ **L'alimentation rejoue toutes les quinze secondes, au rythme des cours.** Animer à
   * chaque passage ferait repartir la courbe de zéro sans cesse, ce qui rendrait la page
   * inutilisable. Le tracé ne se déclenche donc que sur un geste : changement de période,
