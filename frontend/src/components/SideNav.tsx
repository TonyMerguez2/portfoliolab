...
/**
 * La matière du rail et du cadre.
 *
 * ⚠️ **Le flou d'arrière-plan est parti avec la transparence.** Il floutait ce qui passait
 * sous un voile à 80 % ; sous une surface opaque il ne reste rien à flouter, et la règle
 * coûtait une couche de composition — étendue, depuis que la boîte couvre la fenêtre entière,
 * à tout l'écran pour un effet nul.
 */
const MATIERE = {
